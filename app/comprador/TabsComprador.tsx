...
const TABS: TabConfig[] = [
  { name: 'Inicio', label: 'Inicio', icon: 'home-outline', iconActive: 'home', subtitulo: 'Descubre productos frescos del campus', paso: 'Paso 5', color: '#FF6B2B' },
  { name: 'Buscar', label: 'Buscar', icon: 'search-outline', iconActive: 'search', subtitulo: 'Busca y filtra lo que quieres', paso: 'Paso 5', color: '#FFB830' },
  { name: 'Carrito', label: 'Carrito', icon: 'cart-outline', iconActive: 'cart', subtitulo: 'Revisa tu carrito antes de pagar', paso: 'Paso 6', color: '#FF6B2B' },
  { name: 'Mensajes', label: 'Chat', icon: 'chatbubbles-outline', iconActive: 'chatbubbles', subtitulo: 'Habla con los vendedores', paso: 'Paso 7', color: '#FFB830' },
  { name: 'Perfil', label: 'Perfil', icon: 'person-outline', iconActive: 'person', subtitulo: 'Tus datos y ajustes', paso: 'Paso 5', color: '#FF6B2B' },
];
          ...
          >
            ...
            <View style={{ padding: 20 }}>
              ...
              <View style={{ flexDirection: 'row', alignItems: 'center', gap: 14, marginBottom: 20 }}>
                ...
                >
                  <Text style={{ color: '#FF6B2B', fontSize: 11, fontWeight: '700' }}>
                    Comprador
                  </Text>
                </View>
              </View>
      ...
      {TABS.map((tab) => (
        <Tab.Screen
          ...
          options={{
            ...
            tabBarBadgeStyle: { backgroundColor: '#FF6B2B', fontSize: 10, minWidth: 18, height: 18 },
          }}
        >
          {() =>
